...
to real world time. \atnote{Citation?}
...
\begin{figure}
  ...
  We show that CQ and CG are enough \atnote{enough?} to attain the intermediate property of Freshness
  (Theorem~\ref{thm.longest-chain-freshness}, middle). This property is also achieved by Streamlet \atnote{theorem?}, which does
...
\atnote{Rename to freshness and talk about consisten recorded rounds?}
of chains, which we prove for all flavours of blockchains\atnote{The main flavors?}. Namely, we prove the
...
advocated even by \atnote{who is this?}experts\footnote{2016, Badr Bellaj, \href{https://ethereum.stackexchange.com/questions/6795/is-block-timestamp-safe-for-longer-time-periods}{\emph{Is block.timestamp safe for longer time periods?}}, Ethereum StackExchange.} that, because
...
these works by introducing the definitions of timeliness, block freshness\atnote{freshness?}, and supersafety, in a way
