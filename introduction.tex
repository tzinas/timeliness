...
\begin{figure}
  ...
  \begin{tikzpicture}[
    ...
    \node[block, minimum width=1.2cm, minimum height=0.5cm, below=0cm of abcv.south west, anchor=north west] (cq) {CQ};
    \node[block, minimum width=1.2cm, minimum height=0.5cm, right=0cm of cq.east, anchor=west] (cg) {CG};
    \node[block, minimum width=1.2cm, minimum height=0.5cm, right=0cm of cg.east, anchor=west] (cp) {CP};
