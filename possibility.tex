...
stores the longest finalized chain $\chain^P_r$. \atnote{Check if this is needed to clarify}
...
\begin{lemma}[Streamlet Freshness] \label{lem:latest-finalized-round}
