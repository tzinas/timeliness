...
\begin{proof}
  ...
  On the other hand, by Equation~\ref{eq:bitcoin-r-bound}, $r_1 - (r^* + 1) \geq v \geq s$ and
  we can apply Chain Growth between rounds $r^* + 1$ and $r_1$
  with parameters $s, \tau$ to obtain
  $|\chain_1| - |\chain^P_{r^* + 1}| \geq \tau(r_1 - (r^* + 1)) \geq \tau v \geq
