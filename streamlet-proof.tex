...
stores the longest finalized chain $\Chain[][P][r]$.
...
\begin{proof}
  ...
  \atnote{Maybe now we need $3, 8, 13, \ldots$}
  It holds that
...
\begin{theorem}[Temporal Streamlet Freshness] \label{thm:latest-finalized-round}
